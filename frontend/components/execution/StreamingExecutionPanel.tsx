      ...
      {symbols.length > 0 && (
        ...
        >
          ...
          <div className="bg-gray-900/50 rounded-lg p-3 border border-gray-700">
            {/* Header */}
            <div className="grid grid-cols-5 gap-2 text-xs font-semibold text-gray-500 pb-2 border-b border-gray-700 mb-2">
              <span>Label</span>
              <span>Segment</span>
              <span>Type</span>
              <span>Size</span>
            ...
            <div className="space-y-1">
              {symbols.map((symbol: any, i: number) => (
                ...
                >
                  <span className="text-purple-400 font-semibold truncate">{symbol.label}</span>
                  <span className="text-gray-400">{symbol.segment}</span>
                  <span className="text-blue-400">{symbol.type}</span>
                  <span className="text-gray-400">{symbol.size}</span>
                  <span className="text-green-400 truncate">{symbol.value}</span>
                </motion.div>
              ))}
            </div>
          </div>
      ...
      {initialMemory.length > 0 && (
        ...
        >
          ...
          <div className="bg-gray-900/50 rounded-lg p-3 border border-gray-700 max-h-40 overflow-y-auto">
            {/* Header */}
            <div className="grid grid-cols-3 gap-4 text-xs font-semibold text-gray-500 pb-2 border-b border-gray-700 mb-2 sticky top-0 bg-gray-900/50">
              <span>Offset</span>
              <span>Value</span>
              <span>Symbol</span>
            </div>
            ...
            <div className="space-y-1">
              {initialMemory.map((mem: any, i: number) => (
                ...
                >
                  ...
                  <span className="text-gray-400 truncate">{mem.symbol}</span>
                </motion.div>
              ))}
            </div>
          </div>
